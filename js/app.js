(function (root) {
    ...
    function openStreamDialog(eventObj) {
        ...
        apiClient.getStreams(eventObj).then(function (streams) {
            ...
            setTimeout(function () {
                var firstStream = streamList.querySelector(".stream-row");
                if (firstStream) {
    ...
    function playStream(stream) {
        ...
        playerControls.classList.remove("hide-controls");
    ...
    function showPlayerControlsTemporarily() {
        ...
        playerControlTimer = setTimeout(function () {
            ...
            playerControls.classList.add("hide-controls");
    ...
    function closePlayer() {
        ...
        fm.setScope(streamDialog, streamList.querySelector(".stream-row"));
    }
